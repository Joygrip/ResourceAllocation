...
class DemandService:
    ...
    def get_all(self, year: Optional[int] = None, month: Optional[int] = None) -> list[DemandLine]:
        """Get all demand lines, optionally filtered by year/month."""
...
class SupplyService:
    ...
    def get_all(self, year: Optional[int] = None, month: Optional[int] = None) -> list[SupplyLine]:
        """Get all supply lines, optionally filtered by year/month."""
