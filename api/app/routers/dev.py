...
async def seed_database(
    ...
    if existing_dept:
        return MessageResponse(message="Database already seeded for this tenant")
    ...
    return MessageResponse(message=f"Seeded database with sample data for tenant {tenant_id}")
